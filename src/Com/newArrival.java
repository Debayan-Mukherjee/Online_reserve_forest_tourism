...
public class newArrival extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Connection con = debjdbc.initialize(); 
         ...
         ResultSet rs = stmt.executeQuery("SELECT * FROM newArrival");
	    ...
	    out.println("<body>");
	    out.println("<center><h1>New Arrival</h1>");
	   ...
	   out.println("<table>");
	   out.println("<tr><th>House</th><th>Species</th><th>No of Animal</th> <th>From which Zoo</th><th>Date of Arrival</th></tr>");
